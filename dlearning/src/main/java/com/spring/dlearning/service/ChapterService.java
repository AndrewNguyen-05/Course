...
public class ChapterService {
    ...
    @Transactional
<<<<<<<< HEAD:dlearning/src/main/java/com/spring/dlearning/service/LessonService.java
    @PreAuthorize("isAuthenticated() and hasAnyAuthority('ADMIN', 'TEACHER', 'USER')")
...
>>>>>>>> 19449c68 (View Chapter and Lesson and averageRating):dlearning/src/main/java/com/spring/dlearning/service/ChapterService.java
