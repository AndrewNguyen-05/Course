        ...
        <div className="nav-item dropdown mx-2">
            ...
            <ul className="dropdown-menu dropdown-menu-end text-start" style={{ transform: 'translateX(-50%)', left: '50%' }}>
                {isTokenValid === null ? (
                    ...
                    <>
                        <li><Link to="/my-account" className="dropdown-item d-flex align-items-center"><i className="fa-solid fa-circle-user me-2"></i>My Account</Link></li>
                        ...
                        {role === 'USER' &&
                            <li><Link to="/my-courses" className="dropdown-item d-flex align-items-center"><i className="fa-solid fa-book me-2"></i>
                            My Courses</Link></li>
                        }

                        {role === 'TEACHER' &&
                            <li><Link to="/manager-courses" className="dropdown-item d-flex align-items-center"><i className="fa-solid fa-book me-2">
                                </i>Manager</Link></li>
                        }
