          ...
          <div className="row">
            <div className="col-lg-5 mb-5 mb-lg-0" style={{ minHeight: '500px' }}>
              <div className="position-relative h-100">
                <img className="position-absolute w-100 h-100" src={require('./../../img/about.jpg')} alt="About Us" style={{ objectFit: 'cover' }} />
              </div>
            </div>
        ...
        <div className="container py-5">
          <div className="row">
            ...
            <div className="col-lg-5" style={{ minHeight: '500px' }}>
              <div className="position-relative h-100">
                <img className="position-absolute w-100 h-100" src={require('./../../img/feature.jpg')} alt="Features" style={{ objectFit: 'cover' }} />
              </div>
            </div>
          </div>
        </div>
